...
# multiclass datasets: 
#dts = ['turk_student_eval', 'nursery', "drugs", 'wine','concrete', 'skillcraft', 'energy', 'news_popularity',"video_game_sales", 'yeast']
dts = ['concrete', 'skillcraft', 'energy', 'news_popularity',"video_game_sales", 'yeast']
